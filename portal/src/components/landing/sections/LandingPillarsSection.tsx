    ...
    <section className={styles.section}>
      <div className="container">
        ...
        <div className={styles.grid}>
          ...
          <Link to="/framework/management-systems/" className={styles.card}>
          ...
          <Link to="/framework/domain-frameworks/" className={styles.aiCard}>
          ...
          <Link to="/framework/domain-frameworks/" className={styles.wideCard}>
          ...
          <Link to="/framework/audit-and-assurance/" className={styles.wideCard}>
            <div className={styles.wideInner}>
