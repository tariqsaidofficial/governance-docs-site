...
```html
<nav
  class="fixed top-0 w-full z-50 bg-white/80 dark:bg-slate-900/80
...
>
  <div class="flex items-center justify-between px-6 h-16">
    ...
    <div class="flex items-center gap-4">
      <input
        class="hidden sm:block bg-surface-container-lowest
...
```html
<aside
  class="h-screen sticky top-16 w-64 overflow-y-auto
...
>
  ...
  <a
    href="#"
    class="flex items-center gap-3 font-manrope font-semibold text-sm
...
```html
<main
  class="flex-1 min-w-0 bg-surface-container-lowest
...
>
  ...
  <header class="mb-16">
    ...
    <!-- Page Title -->
    <h1
      class="text-4xl md:text-5xl font-extrabold text-on-surface
               tracking-tight mb-6"
    >
      Core Principles
    </h1>
    ...
    <p class="text-lg text-secondary leading-relaxed max-w-3xl">
      This section presents the foundational principles underlying all
      governance decisions and policy implementation across the enterprise
      platform.
    </p>
  </header>
...
>
  ...
  <!-- Code -->
  <code class="block text-blue-200"> # Code content here </code>
</div>
```
...
```html
<aside
  class="hidden xl:block w-72 sticky top-16 h-screen py-12 px-6 overflow-y-auto"
>
  <!-- TOC Header -->
...
```html
<footer
  class="w-full py-12 px-8 mt-20 bg-slate-100 dark:bg-slate-950
...
>
  ...
  <div class="grid grid-cols-1 md:grid-cols-4 gap-8 max-w-7xl mx-auto">
    ...
    <div class="col-span-1 md:col-span-1">
      <div
        class="font-manrope font-bold text-slate-900 dark:text-slate-100 mb-4"
      >
        Technical Governance Portal
      </div>
    ...
    <div class="space-y-3">
      ...
      <div class="flex flex-col gap-2">
        <a
          href="#"
          class="font-inter text-xs text-slate-500 dark:text-slate-400
...
```html
<span class="material-symbols-outlined text-primary text-lg"> icon_name </span>
```
